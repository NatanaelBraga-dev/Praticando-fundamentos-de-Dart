...
class contaBancaria{
 ...
 void sacar(valorSaque){
   ...
   print("seu valor de saque foi $valorSaque e seu saldo atual é de $valorRestante");
   
 }
 
 void depositar(valorDepositado){
   double valorFinal = saldoDaConta + valorDepositado;
   print("o valor depositado foi $valorDepositado o saldo final da sua conta é de: $valorFinal");
